    ...
    return (
      <tr key={m.id}>
        <td className="whitespace-nowrap">
          {format(m.date?.toDate() || new Date(), "d MMM, HH:mm", {
            locale: es,
          })}
        </td>
        ...
        <td
          ...
          title={m.userName || users[m.userId]?.name}
        >
          {m.userName || users[m.userId]?.name || m.userId}
        </td>
        <td
          className="text-xs text-muted max-w-[200px] truncate"
          title={m.notes}
        >
          {m.notes || "-"}
        </td>
                ...
                return (
                  ...
                  >
                    <div className="overflow-x-auto">
                      <table
                        className="table table-grid table-striped min-w-[600px]"
                        style={{ margin: 0 }}
                      >
