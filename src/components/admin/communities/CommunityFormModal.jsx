          ...
          <div className="modal-body">
            ...
            <div className="form-group">
              ...
              <p className="text-xs text-muted mt-1">
                Usa el botón para obtener las coordenadas para el GPS
                automáticamente.
              </p>
            </div>
            <div
              ...
              {editingCommunity && (
                <div style={{ marginTop: "var(--space-3)" }}>
                  {loadingSuggestions ? (
                      ...
                      {gpsSuggestions.map((sug) => (
                        ...
                        >
                          ...
                          <div className="text-xs text-muted mt-1">
                            Lat: {Number(sug.lat || 0).toFixed(7)} | Lng:{" "}
                            {Number(sug.lng || 0).toFixed(7)}
                          </div>
                    ...
                    >
                      💡 Los operarios pueden enviar su ubicación GPS desde la
                      app móvil para mejorar la precisión.
                    </p>
                  )}
                </div>
              )}
            ...
            >
              <label
                className="form-label flex items-center gap-2 cursor-pointer mb-1"
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      individualTimeTracking: e.target.checked,
                    }))
                  }
                />
                <span style={{ fontWeight: "bold" }}>
                  Seguimiento de tiempo individual
                </span>
              </label>
              <p className="text-xs text-muted" style={{ marginLeft: "26px" }}>
                Si se marca, el operario no requerirá iniciar la jornada general
                para trabajar en servicios de esta comunidad. El tiempo general
                se desactivará si todos sus servicios de hoy son individuales.
              </p>
            </div>
            <div
              className="form-group"
            ...
            >
              <label
                className="form-label flex items-center gap-2 mb-1"
                style={{ display: "flex", alignItems: "center" }}
              >
                <span style={{ fontWeight: "bold" }}>
              ...
              <p className="text-xs text-muted" style={{ marginTop: "6px" }}>
                Opcional. Si se indica, el optimizador de recorrido priorizará
                esta comunidad a la hora indicada.
              </p>
            </div>
            ...
            >
              ...
              <div className="form-row mb-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, billingCif: e.target.value }))
                    }
                  />
                </div>
                <div>
              ...
              <div className="form-row mb-3">
                <div>
                  <label className="form-label">
                    Email de Facturación (Múltiples permitidos)
                  </label>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "4px" }}>
                      ...
                      <button
                        ...
                        onClick={() => {
                          const input =
                            document.getElementById("new-billing-email");
                          if (input) {
              ...
              {form.paymentMethod === "recibo" && (
                ...
                >
                  ...
                  >
                    🏦 Datos de Domiciliación Bancaria (SEPA)
                  </h4>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({
                            ...f,
                            billingIban: e.target.value.toUpperCase(),
                          }))
                        }
                        style={{
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({
                            ...f,
                            billingMandateRef: e.target.value,
                          }))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({
                            ...f,
                            billingMandateDate: e.target.value,
                          }))
                        }
                      />
                    </div>
                  ...
                  >
                    Estos datos son necesarios para generar las remesas
                    bancarias SEPA (Cuaderno 19). El mandato debe estar firmado
                    por la comunidad autorizando el cobro.
                  </p>
                </div>
              )}
