            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <span
                style={{
                  ...
                  animation: filterGPS
                    ? "none"
                    : "gpsBadgePulse 2s ease-in-out infinite",
                }}
              >
                {pendingGPSCommunityIds.size}
              </span>
              <div>
                <div
                  style={{
                ...
                >
                  📍 {pendingGPSCommunityIds.size} comunidad
                  {pendingGPSCommunityIds.size > 1 ? "es" : ""} con notificación
                  GPS
                </div>
                <div
                  style={{
                ...
                >
                  {filterGPS
                    ? "✓ Mostrando solo estas comunidades — clic para ver todas"
                    : "Clic para filtrar y revisarlas"}
                </div>
              </div>
            </div>
            <span
              ...
              <div className="flex items-center justify-between">
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    >
                      {comm?.name || "Comunidad sin nombre"}
                    </span>
                    {pendingGPSCommunityIds.has(comm.id) && (
                      <span
                        title="Tiene sugerencias GPS pendientes"
                        style={{
                          background: "#f59e0b",
                          color: "white",
                          borderRadius: "50%",
        ...
        {communities &&
          ...
          filteredCommunities.length === 0 && (
            <div className="empty-state">
              <p>
                {filterGPS
                  ? "✅ Ninguna comunidad con GPS pendiente coincide con la búsqueda"
