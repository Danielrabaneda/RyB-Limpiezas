...
export default function QuotesPage() {
  ...
  const generatePdf = (download = true) => {
    ...
    if (editing.pricingMode === "global") {
      autoTable(pdf, { startY: 87, head: [["Trabajos incluidos", "Frecuencia"]], body: editing.lines.map((l) => [`${l.concept}\n${l.description || ""}`, frequencyLabel(l.frequency)]), headStyles: { fillColor: accent }, styles: { fontSize: 8, cellPadding: 2.5 }, columnStyles: { 0: { cellWidth: 140 }, 1: { cellWidth: 35 } } });
