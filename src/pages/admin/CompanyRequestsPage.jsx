  ...
  return (
    <div style={{ padding: "var(--space-6)", maxWidth: "1000px" }}>
      <div style={{ marginBottom: "var(--space-6)" }}>
        ...
        >
          Leads recibidos desde la landing page. Gestiona el estado de cada
          solicitud.
        </p>
      </div>
      ...
      >
        {[
          ...
          <button
            ...
            style={{
              background:
                filter === c.key ? `${c.color}15` : "var(--color-surface)",
          ...
          >
            <div
              style={{
                fontSize: "1.6rem",
                fontWeight: 900,
                color: filter === c.key ? c.color : "var(--color-text)",
              }}
            >
              {c.value}
            </div>
      ...
      {filtered.length === 0 ? (
        ...
        >
          ...
          <p>
            No hay solicitudes{" "}
            {filter !== "all"
              ? `con estado "${STATUS_CONFIG[filter]?.label}"`
              : "todavía"}
            .
          </p>
          {filter !== "all" && (
                ...
                >
                  <div
                    style={{
                      ...
                      flexShrink: 0,
                      background:
                        "linear-gradient(135deg, #2563eb22, #06b6d422)",
