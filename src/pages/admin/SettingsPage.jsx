...
export default function SettingsPage() {
      ...
      try {
        ...
        setSmtpSettings({
          ...
          emailSubjectTemplate:
            settings.emailSubjectTemplate || "Factura {numero} - RyB Limpiezas",
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      if (isOperario !== (userProfile.isOperario || false))
        updates.isOperario = isOperario;
      ...
      setProfileMsg(
        "Perfil actualizado correctamente. Es posible que debas reiniciar sesión si cambiaste correo o contraseña.",
      );
    } catch (err) {
      console.error(err);
      if (err.code === "auth/requires-recent-login") {
        setProfileMsg(
          "Error: Por motivos de seguridad, para cambiar el correo o contraseña debes haber iniciado sesión recientemente. Cierra sesión y vuelve a entrar.",
        );
      } else {
  ...
  const handleUpdateCompany = async (e) => {
    ...
    try {
      ...
      setCompanyMsg(
        "Ajustes de la empresa actualizados correctamente. Si cambiaste el nombre o logo, recarga la página para ver los cambios.",
      );
    } catch (err) {
      console.error(err);
      ...
      <div className="grid grid-2 gap-6">
        ...
        <div className="card">
          ...
          <form onSubmit={handleUpdateCompany} className="flex flex-col gap-4">
            ...
            <div className="form-group">
              ...
              >
                Comparte este código con los operarios para que puedan
            ...
            {companyMsg && (
              <div
                className={`p-3 rounded text-sm ${companyMsg.includes("Error") ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
              >
                {companyMsg}
              </div>
            )}
        ...
        <div className="card">
          ...
          <form onSubmit={handleUpdateProfile} className="flex flex-col gap-4">
            ...
            <div className="form-group flex items-center gap-2 mt-2">
              ...
              >
                ...
                <span className="block text-xs text-muted">
                  Permite asignarte servicios y aparecer en la lista de
                  operarios
                </span>
              </label>
            </div>
            ...
            {profileMsg && (
              <div
                className={`p-3 rounded text-sm ${profileMsg.includes("Error") ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
              >
                {profileMsg}
              </div>
            )}
        ...
        <div className="card" style={{ gridColumn: "span 2" }}>
          ...
          >
            📧 Configuración de Correo de la Empresa (SMTP)
          </h3>
          <form onSubmit={handleUpdateSmtp} className="flex flex-col gap-4">
            <div className="grid grid-2 gap-4">
              ...
              <div className="form-group">
                <label className="form-label">
                  Email de la Empresa (Usuario SMTP)
                </label>
                <input
                  type="email"
                  className="form-input"
              ...
              <div className="form-group" style={{ gridColumn: "span 2" }}>
                ...
                >
                  ...
                  <label
                    ...
                    style={{ userSelect: "none" }}
                  >
                    <strong>Usar conexión segura SSL/TLS</strong> (Activar para
                    puerto 465, desactivar para puerto 587 u otros)
                  </label>
                </div>
              </div>
              ...
              <div className="form-group" style={{ gridColumn: "span 2" }}>
                ...
                <small style={{ color: "var(--text-muted)" }}>
                  Puedes usar variables dinámicas: <code>{`{numero}`}</code>,{" "}
              ...
              <div className="form-group" style={{ gridColumn: "span 2" }}>
                <label className="form-label">
                  Plantilla del Cuerpo del Correo (Soporta HTML)
                </label>
                <textarea
            ...
            {smtpMsg && (
              <div
                className={`p-3 rounded text-sm ${smtpMsg.includes("Error") ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
              >
                {smtpMsg}
              </div>
            )}
