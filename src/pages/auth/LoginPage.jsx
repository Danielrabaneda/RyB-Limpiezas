    ...
    <div className="login-page">
      <div className="login-card animate-slideUp">
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          <div className="form-group">
            ...
            <input
              ...
              placeholder={
                activeTab === "admin"
                  ? "admin@limpiagest.com"
                  : "operario@ejemplo.com"
              }
              value={email}
        ...
        <div className="mt-4 text-center text-sm">
          ...
          <Link
            to="/register"
            className="font-semibold animate-fadeIn"
        ...
        {activeTab === "operario" ? (
          ...
          <div
            className="install-banner animate-fadeIn mt-6"
            style={{
            ...
            {installPrompt ? (
              <>
                ...
                <p className="text-xs text-muted mt-1">
                  Accede al instante a tu cuadrante de trabajo y ficha
                  geolocalizado sin abrir el navegador.
                </p>
                <button
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ color: "#cbd5e1" }}>
                      <strong>iPhone:</strong> Pulsa el icono{" "}
                      <span
                        style={{
                  ...
                  >
                    <span className="step-icon">🤖</span>
                    <div style={{ color: "#cbd5e1" }}>
                      <strong>Android:</strong> Toca el menú{" "}
                      <span
                        style={{
                          background: "rgba(255,255,255,0.1)",
                          padding: "2px 4px",
        ...
        >
          <Link
            ...
            style={{ fontSize: "var(--font-xs)", textDecoration: "none" }}
          >
