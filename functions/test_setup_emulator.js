...
async function setup() {
  ...
  try {
    ...
    console.log("Creando perfil de usuario huérfano (sin Auth) en Firestore...");
    ...
    console.log(`- Claims de Admin tras borrar (debe ser undefined):`, adminCheck.customClaims);
    console.log(`- Claims de Operario tras borrar (debe ser undefined):`, operarioCheck.customClaims);
