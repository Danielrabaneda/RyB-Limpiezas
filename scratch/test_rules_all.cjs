...
async function runTests() {
  ...
  try {
    ...
    const tempOperarioCred = await signInWithEmailAndPassword(
      auth,
      "test-operario@test.com",
      "password123",
    );
    ...
    console.log(
      `[SETUP] Configurando scheduledServices/${serviceId} con titular: Admin y acompañante: Operario...`,
    );
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Admin no pudo crear factura borrador:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Admin no pudo editar factura borrador:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Admin no pudo crear factura emitida:",
        err.message,
      );
    }
    ...
    console.log(
      "Admin intentando editar campo bloqueado de factura emitida...",
    );
    try {
      await updateDoc(doc(db, "invoices", "inv-sent"), { amount: 250 });
      console.log(
        "  ❌ ERROR: ¡Admin pudo editar campo bloqueado de factura emitida!",
      );
    } catch (err) {
      console.log(
        "  ✅ ÉXITO: Admin no pudo editar campo bloqueado de factura emitida:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Admin no pudo cambiar status de factura emitida:",
        err.message,
      );
    }
    ...
    const operarioCred = await signInWithEmailAndPassword(
      auth,
      "test-operario@test.com",
      "password123",
    );
    console.log(
      `[SETUP] Operario autenticado con UID: ${operarioCred.user.uid}`,
    );
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Operario no pudo crear pedido propio:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.log(
        "  ✅ ÉXITO: Operario no pudo crear pedido ajeno:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Acompañante no pudo crear su propio fichaje:",
        err.message,
      );
    }
    ...
    try {
      ...
      console.error(
        "  ❌ ERROR: Acompañante no pudo fichar para el titular:",
        err.message,
      );
    }
    ...
    console.log(
      "Acompañante intentando fichar para un usuario ajeno al servicio...",
    );
    try {
      ...
      console.log(
        "  ✅ ÉXITO: Operario no pudo fichar para un usuario ajeno:",
        err.message,
      );
    }
